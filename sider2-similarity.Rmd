...
output:
  html_document:
    theme: cosmo
    highlight: pygments
bibliography: bibliography/sider2-parse.bib
csl: bibliography/plos-mod.csl
---

```{r global_options, include=FALSE}
knitr::opts_chunk$set(
  fig.width=10,
  fig.path='figures/similarity/',
  warning=FALSE,
  message=FALSE,
  fig.retina=2
)
...
We use [*dplyr*](http://cran.rstudio.com/web/packages/dplyr/vignettes/introduction.html) and [*reshape2*](http://seananderson.ca/2013/10/19/reshape.html) for data manipulation;
...
# References
```{r, include=FALSE}
knitcitations::write.bibtex(file = file.path('bibliography', 'sider2-parse.bib'))
```